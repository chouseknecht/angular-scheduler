...
angular.module('AngularScheduler', ['Timezones', 'underscore'])
    ...
    function($log, $filter, $timezones, LoadLookupValues, SetDefaults, CreateObject, _) {
    ...
    .factory('CreateObject', ['$filter', 'GetRule', 'Inject', 'SetDefaults', '$timezones', 'SetRule',
    function($filter, GetRule, Inject, SetDefaults, $timezones, SetRule) {
    ...
    .factory('SetRule', ['_', '$log', '$timezones', '$filter', function(_, $log, $timezones, $filter) {
